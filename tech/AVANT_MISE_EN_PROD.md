...
Pattern général visé : `cadremploi.fr/carriere/tech/` — voir la checklist commune
[../AVANT_MISE_EN_PROD.md](../AVANT_MISE_EN_PROD.md) pour le statut de validation avec l'infra.
